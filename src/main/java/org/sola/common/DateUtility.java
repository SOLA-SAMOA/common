...
public class DateUtility {
    ...
    /**
     * Compares if two dates are equal up to second resolution. Milliseconds are not considered as
     * these can be stripped if the date value is serialized through a web service, etc. If one of
     * the dates is null, false is returned. If both dates are null, true is returned.
     *
     * @param date1
     * @param date2
    ...
    /**
     * Adds the specified number of days to todays date. If endOfDay is true, the date returned is
     * the end of the calculated date
     *
    ...
    /**
     * Adds the specified number of days to the stated. If endOfDay is true, the date returned is
     * the end of the calculated date
     *
     ...
     * @param date1
     * @param date2
     * @return The max of the 2 dates. If one date is null, the other date is returned. If both
     * dates are null, null is returned.
     */
    ...
    /**
     * Returns a new date object based on the year, month and day provided. The date is created
     * using a calender to ensure localization of the date created.
     *
     ...
     * @return
     * <code>true</code> if <var>date</var> corresponds to the first day of a year
     * @see Date#getTime()
     */
     ...
     * @param date date to check in millis
     * @return
     * <code>true</code> if <var>date</var> corresponds to the first day of a month
     * @see Date#getTime()
     */
     ...
     * <code>startOfWeek</code>. For example, if you want to find the previous monday relative to
     ...
     * <code>date</code> that has the day of week matching
     * <code>startOfWeek</code>. For example, if you want to find the next monday relative to
     * <code>date</code> you would call
     * <code>getPreviousDay(date, Calendar.MONDAY)</code>.
     *
     * @param date Base date
